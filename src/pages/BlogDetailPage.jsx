...
// Ensure this path is correct relative to BlogDetailPage.jsx
...
// --- ADDED: getBlogImageUrl Helper (assuming it's needed here) ---
// This should ideally live in a utils file, but placing here for simplicity
const getBlogImageUrl = (imageName) => {
  const imageMap = {
      ...
      'accessorize-choker': 'https://www.amrapaliboutique.in/cdn/shop/products/DSC06952_large.jpg?v=1642793977', // Replace with actual URL
      'accessorize-studs': 'https://www.amrapaliboutique.in/cdn/shop/products/IMG_7767_large.jpg?v=1642803540', // Replace with actual URL
      'accessorize-ring': 'https://placehold.co/600x400/cccccc/ffffff?text=Accessorize+Ring', // Replace
      'accessorize-pendant': 'https://www.amrapaliboutique.in/cdn/shop/products/DSC06952_large.jpg?v=1642793977', // Replace (reused choker image temporarily)
      'accessorize-kada': 'https://placehold.co/600x400/cccccc/ffffff?text=Accessorize+Kada', // Replace
      'must-have-white-red': 'https://www.amrapaliboutique.in/cdn/shop/products/1_b666a4ca-6278-4e05-a20f-1afe57de0e2b_large.jpg?v=1658160157', // Example - Replace
      'must-have-black': 'https://www.amrapaliboutique.in/cdn/shop/products/1_62c51c43-d8e3-4803-b2b1-af743af3ef89_large.jpg?v=1572939766', // Example - Replace
      'must-have-lightweight': 'https://www.amrapaliboutique.in/cdn/shop/products/DSC02573_large.jpg?v=1651044569', // Example - Replace
      'must-have-benarasi': 'https://www.amrapaliboutique.in/cdn/shop/files/IMG_6787_large.jpg?v=1725168737', // Example - Replace
      'must-have-silk': 'https://www.amrapaliboutique.in/cdn/shop/products/1_fcd78349-4218-400e-8e1a-ef359c4513fd_large.jpg?v=1581768880', // Example - Replace
      'must-have-tussar': 'https://www.amrapaliboutique.in/cdn/shop/products/1_b666a4ca-6278-4e05-a20f-1afe57de0e2b_large.jpg?v=1658160157', // Example - Replace
      'must-have-white': 'https://www.amrapaliboutique.in/cdn/shop/products/1_3_88a70303-edb0-40f2-844a-9aaa053482c8_large.jpg?v=1589819889', // Example - Replace
      'must-have-mood': 'https://www.amrapaliboutique.in/cdn/shop/products/1_c9cfb7f4-e0f8-49fa-9aa2-1ee388d62aae_large.jpg?v=1597351082', // Example - Replace
...
const renderContentBlock = (block, index) => {
    switch (block.type) {
        ...
        case 'heading':
            const HeadingTag = `h${block.level || 4}`; // Default level 4
            // Ensure text exists before rendering
        ...
        case 'linkList':
             return (
                <div key={index} className="blog-link-list my-3">
                    {block.links?.map((link, linkIndex) => ( // Add optional chaining
                        link.url && link.text ? ( // Check if link has url and text
                            <a
                                href={link.url}
                                key={linkIndex}
        ...
        case 'paragraphWithLink': // Handles paragraph containing a link
            return (
                <p key={index}>
                    {renderTextWithBold(block.text)}
                    {block.url && block.linkText && ( // Check if link parts exist
                        <a
                            href={block.url}
        ...
        case 'numberedList':
            return (
                <ol key={index} className="blog-numbered-list">
                    {block.items?.map((item, itemIndex) => { // Add optional chaining
                        // Split item text by newline for potential multi-line list items
...
const BlogDetailPage = ({ postId, setPage }) => {
    // Find the blog post by ID and its index
    const postIndex = blogPosts.findIndex(p => p && p.id === postId); // Check if p exists
    ...
    // Navigation Logic - Add checks for valid index
    ...
    // Get related posts - Add check for valid post objects
            ...
            <Row className="justify-content-center pt-4">
                <Col md={9} lg={8}>
                    ...
                    <div className="blog-detail-content">
                        {/* Render structured content using the updated helper */}
                        {/* Add optional chaining and check if it's an array */}
                        ...
                        <div className="related-posts-section mt-5">
                            <Row>
                                {relatedPosts.map(relatedPost => (
                                    relatedPost ? ( // Add check if relatedPost is valid
