...
const HomePage = ({ setPage, onCollectionItemClick }) => {
    ...
    const pageStyles = `
        ...
        .category-card { position: relative; overflow: hidden; text-align: center; color: white; cursor: pointer; }
        .category-card img { width: 100%; height: auto; transition: transform 0.4s ease; display: block; }
        .category-card:hover img { transform: scale(1.05); }
        .category-card .card-img-overlay { background: rgba(0,0,0,0.3); display: flex; flex-direction: column; justify-content: center; align-items: center; transition: background-color 0.3s ease; }
        .category-card:hover .card-img-overlay { background: rgba(0,0,0,0.45); }
        ...
        .btn-buy-now-week { background-color: #ffb3ba; color: #ffffff; border: none; } /* Original Buy Now Style */
        ...
        <>
            ...
            <Container className="homepage-section">
                ...
                {productOfTheWeek ? (
                    ...
                    <Row><Col><p className="text-center text-muted">No products available to feature this week.</p></Col></Row>
                )}
            </Container>
