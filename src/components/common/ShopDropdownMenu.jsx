...
// --- FIX: Accept onMouseEnter prop ---
const ShopDropdownMenu = ({ handleNavClick, onMouseEnter }) => { //

  return (
    // --- FIX: Attach onMouseEnter to the root div ---
    <div 
        className="shop-dropdown-menu" //
        onMouseEnter={onMouseEnter} // This clears the close timer
    >
      <Container> {/* */}
        <Row> {/* */}
          {/* Column 1: Sarees */}
